...
/**
 * This class is a utility class used with the {@link com.rkc.zds.AppMessage.spring.wiki.WikiMessage} class
...
public class AppMessageParam {
	 ...
	 */
	public AppMessageParam(String param) {
		this.param = param;
	}
	 ...
	 * value should be properly escaped prior to being stored as a parameter.
	 */
	public AppMessageParam(String param, boolean isWikiLink) {
		this.param = param;
	 ...
	 */
	public AppMessageParam(String linkValue, String linkText) {
